...
{{--<script src="{{ asset('/js/responsivetable.js') }}"></script>--}}
    <script>
        (function addTableEvents() {
            ...
            let tableRows = table.querySelectorAll('.clickable-table-data');

            let row_links = table.querySelectorAll('.row-link');
        ...
        function createTableElements(val){
            ...
            let noOfCols = document.getElementById('{{ $id }}').rows[0].cells.length;
